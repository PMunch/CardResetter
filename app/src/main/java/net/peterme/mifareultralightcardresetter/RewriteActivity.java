            ...
            if(tag!=null){
                ...
                if(correct)
                {
                    noti = new Notification.Builder(this)
                            .setContentTitle(getString(R.string.state_written_short))
                ...
                noti = new Notification.Builder(this)
                        .setContentTitle(getString(R.string.state_unknown_short))
                        .setContentText(getString(R.string.state_unknown))
                        .setSmallIcon(R.drawable.ic_stat_notify_icon)
                        .build();
            }
            mifare.close();
